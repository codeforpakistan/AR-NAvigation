...
public class FeaturesVisualizer : MonoBehaviour, PlacenoteListener
{
	...
	{
        Debug.Log("enable point cloud start");
        ...
        Debug.Log("enable point cloud end");
    }
	...
	{
        Debug.Log("disable point cloud start");
        sInstance.CancelInvoke ();
		clearPointcloud ();
        Debug.Log("disable point cloud end");
	...
	{
        Debug.Log("clear point cloud start");

        MeshFilter mf = sInstance.mMap.GetComponent<MeshFilter> ();
		mf.mesh.Clear ();
        Debug.Log("clear point cloud end");
